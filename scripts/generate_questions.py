#!/usr/bin/env python3
"""
Generate test questions from Wikipedia articles for RAGAS evaluation.

Usage:
    python scripts/generate_questions.py --num-questions 500 --output data/eval/generated_questions.jsonl
    python scripts/generate_questions.py --num-questions 50 --folders AA AB AC  # Test with first 3 folders
"""
